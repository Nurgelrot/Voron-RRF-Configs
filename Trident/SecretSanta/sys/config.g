...
M906 X1100 Y1100 Z1100 E700 I30                     ; set motor currents (mA) and motor idle factor in per cent
...
M208 X349 Y350 Z240 S0                              ; set axis maxima -Stock Trident, short Z NOT CUBED
                                                    ;
;==================================                 ;
; Endstops                                          ;
...
;==================================                 ;
; Z-Probe (TAP)                                     ;    
;==================================                 ; Voron OptoTAP pcb 5V|sig|gnd on 124.io0(5V)
M558 P8 C"^124.io2.in" H5 F600:120 T18000 A5 S0.01  ; set Z probe type to switch and the dive height + speeds
G31 P500 X0 Y0 Z-0.99                               ; set Z probe trigger value, offset and trigger height
M671 X-50:175:400 Y18:398:18 S5                     ; define positions of Z leadscrews or bed levelling screws -VORON Trident 350 bed.
M557 X15:335 Y15:335 P8                            ; define mesh grid
                                                    ;
;==================================                 ;
; Heaters                                           ;
;==================================                 ;
...
M150 E1 P128 B128 S1 F0                             ; set the voron symbol purple
                                                    ;
;==================================                 ;
; Tools                                             ;
;==================================                 ;
